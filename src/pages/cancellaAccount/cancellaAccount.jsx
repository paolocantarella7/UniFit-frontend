    ...
    return (
      <div className="page">
        ...
        <div className="container-fluid text-dark rounded w-75 text-center bg-white my-4">
          <p className="pt-4">
            Confermi di voler cancellare il tuo account definitivamente?
          </p>
          <div className="row py-3 px-3">
            <button
              type="button"
              class="btn btn-danger btn-lg mx-auto bg-cyan border h3 col-xs-12 col-md-8"
              data-toggle="modal"
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button
                  ...
                  onClick={this.effettuaCancellazione}
                >
                  Cancella
                </button>
                <button

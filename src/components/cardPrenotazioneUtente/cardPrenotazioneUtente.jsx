          ...
          <div className="row justify-content-between">
            ...
            <div className="col-md-4 ">
              <Link to="/viewReservations" className="navbar-brand">
                <img className="img-responsive" src="assets/images/delete.png" alt="delete" data-toggle="modal" data-target="#modalEliminaPrenotazione" onClick={() => this.props.onPress(this.props.prenotazione.idPrenotazione)} style={{ height: "25px", width: "25px" }} />
              </Link>

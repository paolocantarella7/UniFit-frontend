...
const FormModifica = (props) => {
  ...
  const findFormErrors = () => {
    ...
    if (!durataPerFascia || durataPerFascia === "")
      newErrors.durataPerFascia = "durata fascia vuota!";
    // start date errors
    if (!dataInizioDisponibilita || dataInizioDisponibilita === "")
      newErrors.dataInizioDisponibilita = "data vuota!";
    // capacity errors
    ...
    if (!oraInizioMattina || oraInizioMattina === "")
      newErrors.oraInizioMattina = "ora inizio mattina vuota!";
    // end morning errors
    if (!oraFineMattina || oraFineMattina === "")
      newErrors.oraFineMattina = "ora fine mattina vuota!";
    else if (oraFineMattina >= oraInizioPomeriggio)
      newErrors.oraFineMattina = "ora non valida";
    // start evening errors
    if (!oraInizioPomeriggio || oraInizioPomeriggio === "")
      newErrors.oraInizioPomeriggio = "ora inizio pomeriggio vuota!";
    else if (oraInizioPomeriggio >= oraFinePomeriggio)
      newErrors.oraInizioPomeriggio = "ora non valida";
    // end evening errors
    if (!oraFinePomeriggio || oraFinePomeriggio === "")
      newErrors.oraFinePomeriggio = "ora fine pomeriggio vuota!";
          ...
          <Row className="mb-1 my-3">
            <Form.Group as={Col} md="5" className="mx-auto">
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setField("dataInizioDisponibilita", e.target.value)
                }
                isInvalid={!!errors.dataInizioDisponibilita}
              />
              <Form.Control.Feedback type="invalid">
                {" "}
                {errors.dataInizioDisponibilita}{" "}
              </Form.Control.Feedback>
            </Form.Group>
          ...
          <Row className="mb-2">
            <Form.Group as={Col} md="5" className="mx-auto">
              ...
              <Form.Control
                ...
                onChange={(e) =>
                  setField("oraInizioPomeriggio", e.target.value)
                }
                isInvalid={!!errors.oraInizioPomeriggio}
              />
              <Form.Control.Feedback type="invalid">
                {" "}
                {errors.oraInizioPomeriggio}{" "}
              </Form.Control.Feedback>
            </Form.Group>
